...
import DELIVERYPAYMENT_ROUTE from '../utils/consts'

const Menu = ({handleClose}) => {
    return (
        <div className='menu' style={{width: '100vw', height: '100vh', position: 'absolute', top: 0, alignItems: 'flex-end', flexDirection: 'column'}}>
            <div style={{width: '100%', background: '#ED5A51', color: '#f4f4f4', display: 'flex', flexDirection: 'column', paddingLeft: '32px'}}>
                ...
                <Link onClick={handleClose} style={{color: '#f4f4f4', textDecoration: 'none', fontFamily: 'Raleway', fontSize: 36, lineHeight: '42px'}} to='/delivery-payment'>
                    Доставка и оплата
