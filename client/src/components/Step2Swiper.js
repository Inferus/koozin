...
const noSpilthoodiesBlack = [a_b_ban_all,a_b_apr_all,a_b_man_all,a_b_ibi_all,a_b_pal_all,a_b_hea_all,a_b_pin_all,a_b_car_all,a_b_tar_all,a_b_pop_all]
const noSpilthoodiesWhite = [a_w_ban_all,a_w_apr_all,a_w_man_all,a_w_ibi_all,a_w_pal_all,a_w_hea_all,a_w_pin_all,a_w_car_all,a_w_tar_all,a_w_pop_all]
const noSpilthoodiesGrey = [a_g_ban_all,a_g_apr_all,a_g_man_all,a_g_ibi_all,a_g_pal_all,a_g_hea_all,a_g_pin_all,a_g_car_all,a_g_tar_all,a_g_pop_all]
let noSpilthoodies
...
const Step2Swiper = () => {
   ...
   useEffect(()=>{ 
    ...
    handleChangeColor()
    handleChangeHood()
    handleSelectFirstComplect()
    if (selector === 'black') {
        noSpilthoodies = noSpilthoodiesBlack
    } else if (selector === 'white') {
        noSpilthoodies = noSpilthoodiesWhite
    } else if (selector === 'grey') {
        noSpilthoodies = noSpilthoodiesGrey
}
...
export {Step2Swiper, firstComplect};